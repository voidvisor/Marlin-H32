...
CPP_SRCS += \
../Sources/framework/cores/dtostrf.cpp 

OBJS += \
./Sources/framework/cores/dtostrf.o 

CPP_DEPS += \
./Sources/framework/cores/dtostrf.d 


# Each subdirectory must supply rules for building sources it contributes
Sources/framework/cores/%.o: ../Sources/framework/cores/%.cpp Sources/framework/cores/subdir.mk
	@echo 'Building file: $<'
